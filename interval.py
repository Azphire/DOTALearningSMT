...
def double_complement_intervals(interval_pair):
    result = []
    for intv in complement_intervals(interval_pair[0]):
        result.append((intv, Interval("[0,+)")))
    for intv in complement_intervals(interval_pair[1]):
        result.append((Interval("[0,+)"), intv))
    return result
